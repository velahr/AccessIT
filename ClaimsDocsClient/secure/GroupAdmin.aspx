<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="GroupAdmin.aspx.cs" Inherits="ClaimsDocsClient.secure.GroupAdmin" %>

<html xmlns="http://www.w3.org/1999/xhtml">
<head id="Head1" runat="server">
    <title>ClaimsDocs : Group Administration</title>
                ...
                <td class="main" align="center">
                    <div class="nav" align="left">
                        <table>
                            <tr>
                                <td>
                                    You are visiting: <a class="nav" href="#" onclick="window.location.replace('AdminNonDocs.aspx')">Administration</a> &rarr; <a class="nav" href="#" onclick="window.location.replace('GroupList.aspx')">Groups</a> &rarr; <span class="nav">Add Group</span>
                                    <td>
                            </tr>
                        </table>
                    </div>
                        ...
                        <fieldset>
                            <table class="body" cellspacing="8">
                                        ...
                                        <table border="0" cellpadding="0" cellspacing="0" width="400px">
                                            <tr>
                                                <td colspan="1" align="right">
                                                    ...
                                                    <asp:Label ID="lblGroupID" runat="server" Visible="false" Text="0"></asp:Label>
                                                    Group Name : 
                                                </td>
                                                ...
                                                <td>
                                                    <asp:RequiredFieldValidator id="valtxtGroupName" runat="server" ControlToValidate="txtGroupName" ErrorMessage="required"></asp:RequiredFieldValidator>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td colspan="1" align="right">
                                ...
                                <tr>
                                    ...
                                    <td align="center" colspan="1">
                                        <input style="width:8em;text-align: center" class="button" type="button" value="Cancel" onclick="window.location.replace('grouplist.aspx')" />
                                    </td>
