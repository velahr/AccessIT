<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ProgramList.aspx.cs" Inherits="ClaimsDocsClient.secure.ProgramList" %>

<html xmlns="http://www.w3.org/1999/xhtml">
<head id="Head1" runat="server">
    <title>ClaimsDocs : Program List</title>
                ...
                <td class="main" align="center">
                    <div class="nav" align="left">
                        <table>
                            <tr>
                                <td>
                                    You are visiting: <a class="nav" href="#" onclick="window.location.replace('AdminNonDocs.aspx')">Administration</a> &rarr; <span class="nav">Program</span>
                                    <td>
                            </tr>
                        </table>
                    </div>
                    <div class="body">
                        <fieldset>
                            <table class="body" cellspacing="8">
                                <tr>
                                    <td valign="top">
                                        Select one program below to Edit or:&nbsp;
                                    </td>
                                  <td>
                                     <input class="flat" type="button" value="Add a new Program" onclick="window.location.replace('ProgramAdmin.aspx?state=1&programid=0')">
                                  </td>
                                ...
                                <tr>
                                    <td colspan="2" align="center">
                                        <table border=1 cellpadding=0 cellspacing=0>
                                            <tr>
                                                <td colspan=2>
                                                    <asp:LinkButton ID="lnkSortByProgramName" runat="server" Text="Program Code" onclick="lnkSortByProgramName_Click"></asp:LinkButton> <asp:Label ID="lblSortOrder" Text="ASC" runat="server" Visible="false"></asp:Label>
                                                </td>
                                            </tr>
                                                ...
                                                <td colspan=2 align="center">
                                                    ...
                                                    <Columns>
                                                            ...
                                                            <asp:templatecolumn headertext="" >
                                                                <ItemTemplate>
		                                                            <input class="flat" type="button" value="Edit" onclick="window.location.replace('ProgramAdmin.aspx?state=2&programid=<%# DataBinder.Eval(Container.DataItem, "ProgramID")%>')">
                                                                </ItemTemplate>
