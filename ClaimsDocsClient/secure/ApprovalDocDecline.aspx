<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ApprovalDocDecline.aspx.cs" Inherits="ClaimsDocsClient.secure.ApprovalDocDecline" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml">
<head id="Head1" runat="server">
    <title>ClaimsDocs : Document Decline</title>
                                    ...
                                    <td colspan="2">
                                        <table>
                                            <tr>
                                                ...
                                                <td>
                                                    <asp:TextBox ID="txtReasonDocumentRejected" runat="server" Rows="6" Height="126px" Width="300px"></asp:TextBox>
                                                </td>
                                            </tr>
                                        </table>
                                       </td>
                                    ...
                                    <td align="center">
                                        <table>
                                            <tr>
                                                ...
                                                <td>
                                                    <asp:Button class="button" ID="cmdSubmit" runat="server" Text="Submit" onclick="cmdSubmit_Click" />
                                                </td>
                                                <td>
