<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="DepartmentAdmin.aspx.cs" Inherits="ClaimsDocsClient.secure.DepartmentAdmin" %>

<html xmlns="http://www.w3.org/1999/xhtml">
<head id="Head1" runat="server">
    <title>ClaimsDocs : Department Administration</title>
                ...
                <td class="main" align="center">
                    <div class="nav" align="left">
                        <table>
                            <tr>
                                <td>
                                    You are visiting: <a class="nav" href="#" onclick="window.location.replace('AdminNonDocs.aspx')">Administration</a> &rarr; <a class="nav" href="#" onclick="window.location.replace('DepartmentList.aspx')">Departments</a> &rarr; <span class="nav">Add Department</span>
                                    <td>
                            </tr>
                        </table>
                    </div>
                        ...
                        <fieldset>
                            <table class="body" cellspacing="8">
                                    ...
                                    <td colspan="2" align="center">
                                        <table border="0" cellpadding="0" cellspacing="0" width="400px">
                                            <tr>
                                                ...
                                                <td>
                                                    <asp:RequiredFieldValidator id="valtxtDepartmentName" runat="server" ControlToValidate="txtDepartmentName" ErrorMessage="required"></asp:RequiredFieldValidator>
                                                </td>
                                            </tr>
                                        </table>
                                ...
                                <tr>
                                    ...
                                    <td align="center" colspan="1">
                                        <input style="width:8em;text-align: center" class="button" type="button" value="Cancel" onclick="window.location.replace('DepartmentList.aspx')" />
                                    </td>
